 ...
 * @since 1.0.0
 */
public class AuditEventImpl extends EventImpl implements AuditEvent {
     ...
     *            the fields
     */
    public AuditEventImpl(final String actor, final String action, Field... fields) {
        this.actor = actor;
        this.action = action;
     ...
     *            the fields
     */
    public AuditEventImpl(final String actor, final String action, final String origin, Field... fields) {
        this.actor = actor;
        this.action = action;
        this.origin = origin;
        for (Field field : fields) {
     ...
     * {@inheritDoc}
     * 
     * @see EventImpl#setRepository(java.lang.String)
     *
     */
    @Override
